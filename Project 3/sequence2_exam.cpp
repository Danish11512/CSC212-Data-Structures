...
int test8()
{
    ...
    std::cout << "size of the array. For example, if the current capacity is 1000\n";
    std::cout << "and the sequence has only 10 items, then resize(100) should\n";
    std::cout << "reduce the current capacity down to 100.\n";
    ...
    {
        std::cout << "    Test failed. Resize cannot be used to reduce capacity." << std::endl;
        return 0;
    }
